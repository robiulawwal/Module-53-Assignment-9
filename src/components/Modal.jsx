  ...
  return (
    <dialog id={`my_modal_${word.id}`} className="modal">
      <div className="modal-box bg-gradient-to-br from-purple-100 to-pink-100 border-2 border-purple-300 rounded-xl shadow-2xl p-8">
        {/* Modal Header */}
        <h3 className="text-2xl md:text-4xl font-bold text-purple-800 mb-2 md:mb-6 text-center">
          {word.word}
        </h3>
        ...
        <div className="mt-2 md:mt-8">
          <h4 className="text-xl md:text-2xl font-bold text-purple-700 md:mb-3">When to Say</h4>
          <p className="text-gray-700 md:text-lg">{word.when_to_say}</p>
        </div>

        {/* Example */}
        <div className="mt-3 md:mt-8">
          <h4 className="text-xl md:text-2xl font-bold text-purple-700 mb-1 md:mb-3">Example</h4>
        ...
        {/* Close Button */}
        <div className="modal-action md:mt-10">
